...
const siteData = {
  business: {
    name: "One Life Aqua",
    legalName: "One Life Aqua & Recreation Centre",
    tagline: "One Life. Live It Fully.",
    description:
      "One Life Aqua & Recreation Centre is Harare's premier aquatic and recreation facility. Featuring Olympic-standard pools, fitness areas, and event spaces, we provide a complete wellness and entertainment destination.",
    phone: "+263 77 228 8999",
    phoneRaw: "+263772288999",
    whatsappNumber: "263772288999",
  ...
  hero: {
    ...
    backgroundImages: [
      { url: "https://images.unsplash.com/photo-1562778612-e1e0cda9915c?w=1200&fit=crop&q=80", alt: "One Life Aqua professional image 1" },
      { url: "https://images.unsplash.com/photo-1575429198097-0414ec08e8cd?w=1920&q=85", alt: "One Life Aqua professional image 2" },
      { url: "https://images.unsplash.com/photo-1562778612-e1e0cda9915c?w=1200&fit=crop&q=80", alt: "One Life Aqua showcase" },
    ],
  },
    ...
    items: [
      {
        ...
        image: "https://images.unsplash.com/photo-1562778612-e1e0cda9915c?w=1200&fit=crop&q=80",
      },
      {
        title: "Swimming Lessons",
    ...
    items: [
      {
        ...
        image: "https://images.unsplash.com/photo-1562778612-e1e0cda9915c?w=1200&fit=crop&q=80",
        images: [
          "https://images.unsplash.com/photo-1562778612-e1e0cda9915c?w=1200&fit=crop&q=80",
  ...
  about: {
    ...
    story: [
      "One Life Aqua & Recreation Centre was built on the principle that every person deserves access to world-class aquatic and fitness facilities. Since opening on Dorset Road, we have served over 5,000 members and hosted hundreds of events.",
  ...
  homeCta: {
    ...
    backgroundImage: "https://images.unsplash.com/photo-1562778612-e1e0cda9915c?w=1200&fit=crop&q=80",
  },

  footer: {
    description: "One Life Aqua & Recreation Centre is Harare's premier aquatic and recreation facility. Featuring Olympic-standard pools, fitness areas, and event spac...",
